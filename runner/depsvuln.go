...
// advisory osv-scanner counts (see depsGroups). 128, no supported lockfile, is an error rather than an empty pass,
...
// advisory. internal/verify/depsvuln.go keeps a copy; change both together.

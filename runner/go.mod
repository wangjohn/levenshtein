...
replace (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.20.0 => go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.20.0
)
...
replace (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.20.0 => go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.20.0
)

replace (
	go.opentelemetry.io/otel/log => go.opentelemetry.io/otel/log v0.16.0
	go.opentelemetry.io/otel/log v0.20.0 => go.opentelemetry.io/otel/log v0.20.0
)

replace (
	go.opentelemetry.io/otel/sdk/log => go.opentelemetry.io/otel/sdk/log v0.16.0
	go.opentelemetry.io/otel/sdk/log v0.20.0 => go.opentelemetry.io/otel/sdk/log v0.20.0
)

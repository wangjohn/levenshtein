...
**Next:** wrap a Go repo's existing tests alongside lint and run both from that repo's CI. Levenshtein's own workflow and daily schedule check its runner and fixtures.

...
func TestRepositoryRunsPlanTheSameCheckIDs(t *testing.T) {
	...
	native := []string{"native-go-lint/root", "native-go-lint/runner", "native-go-lint/lint", "native-go-lint/example", "native-go-vet/root", "native-go-vet/runner", "native-go-vet/lint", "native-go-vet/example", "native-go-mod/root", "native-go-mod/lint", "native-go-mod/tools", "native-go-mod/example", "native-workflow-lint", "native-workflow-security", "native-shell-lint", "native-secrets"}
	dagger := []string{"go-lint/root", "go-lint/runner", "go-lint/lint", "go-lint/example", "go-vet/root", "go-vet/runner", "go-vet/lint", "go-vet/example", "go-mod/root", "go-mod/lint", "go-mod/tools", "go-mod/example", "workflow-lint", "workflow-security", "shell-lint", "secrets"}

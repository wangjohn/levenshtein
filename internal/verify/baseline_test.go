...
func TestLoadBaseline(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		"unsupported kind": {`{"version": 1, "findings": [{"kind":"go-vet","dir":".","file":"a.go","code":"go-vet","message":"e","count":1}]}`, `kind "go-vet" cannot be baselined; only go-http, go-lint, go-sql`},

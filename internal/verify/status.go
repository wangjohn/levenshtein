...
var checkKinds = []CheckKind{CheckGoLint, CheckGoVet, CheckGoHTTP, CheckGoSQL, CheckGoVuln, CheckWorkflowLint, CheckSelfTest, CheckCommand, CheckSemanticLint, CheckGoMutation}

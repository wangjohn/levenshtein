...
- **Check**: a `kind` (`go-lint`, `go-vet`, `go-mod`, `go-test`, `go-http`,
  `go-sql`, `go-vuln`, `workflow-lint`, `workflow-security`, `self-test`, `command`,
...
function on that session (`goLintReport`, `selfTest`, or `sharedCheck` for
